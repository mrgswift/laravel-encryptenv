**v1.0.3** - Added Laravel 7 Support + Bug fix preventing AES-256-CBC cipher from working properly **(Everyone should update to this version for everything to work properly)** 
